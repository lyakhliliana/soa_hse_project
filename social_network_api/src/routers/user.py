...
@user_app.post('', summary='Создать нового пользователя')
...
@user_app.put('', summary='Обновление информации о пользователе')
...
@user_app.post('_authentication', response_model=SessionKey, summary='Аутентификация в системе по логину и паролю')
